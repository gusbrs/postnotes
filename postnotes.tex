...
that reason, but you'll probably also want to set \opt{maketextmark},
\opt{pretextmark}, or \opt{posttextmark} to values different than the
defaults.
...
counter (see \zcref{ex:x:float} at \zcref{sec:further-examples} for an
